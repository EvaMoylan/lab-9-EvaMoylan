...
results |>
  ...
  mutate('3' = as.integer('0'),
         .after = '2') |> #Looks like there are no 3s, so add that to the table
  knitr::kable("html",
               align = "c",
               caption = "Table 1: Proportion of simulations where 0, 1, 2, 3, and 4 babies were given to their correct parents.") |> 
...
results |>
  ...
  labs(y = NULL,
       ...
       title = "Simulated Proportion of Correct Baby-Parent Pairings") 
